...
public class FubScapeMClassificationOp extends Operator {
    ...
    public static final String REFLECTANCE_BAND_PREFIX = "reflectance_";
    ...
    private Product computeRadiance2ReflectanceProduct(Product sourceProduct) {
        HashMap<String, Object> parameters = new HashMap<>();
        parameters.put("sensor", "MERIS");
        return GPF.createProduct("Rad2Refl", parameters, sourceProduct);
    }
    ...
    private void setupCloudScreeningBitmasks(Product gaCloudProduct) {
        ...
        Mask mask = Mask.BandMathsType.create("F_INVALID", "Invalid pixels", w, h,
